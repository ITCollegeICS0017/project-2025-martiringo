...
public:
  ...
  void createOrder() {
    cout << "The receptionist will input the client details and the completion "
            "time"
         << endl;
    cout << "It will create the main order, with the main template (OrderData)"
         << endl;
  }
  ...
  // I don't know if I need to create a struct or something similar for the
  // reports, will see in the future
  void generateReport() {
