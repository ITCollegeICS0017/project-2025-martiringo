...
public:
    ...
    void setOrderToClient(int idClient) {
        orderIds.push_back(idClient);
    }
    ...
    void setCompletionTime(string com) {
        completionTime = com;
    }
...
public:
    ...
    void createOrder(int clientId, string completionTime, ServiceType service) {
        // I need to get the completion time and the service from the Client struct and then create the order with it
    }
