...
class Client {
 private:
  ...
  void setOrderToClient(int orderId) {
    ...
    cout << "New order - " << orderId << " - added to the client - " << clientId
         << " -" << endl;
  }
...
class Receptionist {
 ...
 public:
  ...
  void createClient(string name) {
    ...
    // Logs
    cout << "Client created with id - " << clientIdInc - 1 << " - and name - "
         << name << endl;
  }
...
int main() {
  ...
  while (running) {
    ...
    cout << "2. Create order\n";
    cout << "3. View data\n";  // View functionility for the photographer or
                               // receptionist
    cout << "4. Start order\n";
    ...
    cin >> studioChoice;
    if (studioChoice < 1 || studioChoice > 2) {
      throw runtime_error("Wrong studio");
    }
    ...
    switch (choice) {
      ...
      case 3: {
        ...
        if (viewChoice == 1) {
          ...
          cout << "Number of orders: " << client.getAllOrderIds().size()
               << endl;
        ...
        while (true) {
          if (!todayOrders.empty()) {
            ...
            for (OrderPhotographer order : todayOrders) {
              ...
              auto timestamp =
                  system_clock::to_time_t(order.completionTimestamp);
      ...
      case 6: {
        ...
        for (int id : doneOrders) cout << "- Order ID: " << id << endl;
